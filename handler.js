...
└─────────────
To deactivate this function, please write 
*/off antidelete*
*.enable delete*
`.trim(), msg, {
...
global.dfail = (type, m, conn) => {
    let msg = {
        ...
        mods: '🔰 This command can only be used by the Bot Owner.',
        premium: '💠 This command is only for members *Premium*\n\nEscribe */premium* more info',
        ...
        unreg: '📇 Register to use this feature:\n\n*/reg name.age*\n\n📌Ejemplo : */reg Alexa.16*',
        restrict: '🔐 The feature is *disabled*'
    }[type]
